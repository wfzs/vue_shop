<template>
  <el-container class="home-container">
    <el-header>
      <div>
        <img src="../assets/heima.png" alt="头像" />
        <div>
          <span>电商管理系统</span>
        </div>
      </div>
    ...
    <el-container>
      ...
      <el-aside :width="!isCollapse ? '200px':'64px'">
        ...
        active-text-color="#4034b2" unique-opened :collapse="isCollapse" :collapse-transition="false" router
...
export default {
  ...
  methods: {
    ...
    getMenuList() {
      this.$https.get('menus').then(response => {
