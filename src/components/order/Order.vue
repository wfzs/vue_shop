<template>
  <div>
    ...
    <el-dialog title="物流进度" :visible.sync="progressVisible" width="50%">
      <el-timeline>
        <el-timeline-item
          v-for="(activity, index) in progressInfo" :key="index" :timestamp="activity.time" :icon="index === 0 ? 'el-icon-location' : ''" :color="index === 0 ? 'rgb(11, 189, 135)' : ''" :size="index === 0 ? 'large' : 'normal'">
          {{activity.context}}
        </el-timeline-item>
      </el-timeline>
    </el-dialog>
